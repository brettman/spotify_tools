...
{
    /// <inheritdoc />
    public partial class AddPlayHistoryAnalyticsViews : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            // 5. Listening patterns by day of week
            migrationBuilder.Sql(@"
        ...
        {
            migrationBuilder.Sql("DROP VIEW IF EXISTS v_recent_plays;");
            migrationBuilder.Sql("DROP VIEW IF EXISTS v_plays_by_context;");
            migrationBuilder.Sql("DROP VIEW IF EXISTS v_artist_play_counts;");
            migrationBuilder.Sql("DROP VIEW IF EXISTS v_genre_play_counts;");
            migrationBuilder.Sql("DROP VIEW IF EXISTS v_plays_by_day_of_week;");
            migrationBuilder.Sql("DROP VIEW IF EXISTS v_plays_by_hour;");
            migrationBuilder.Sql("DROP VIEW IF EXISTS v_plays_by_date;");
            migrationBuilder.Sql("DROP VIEW IF EXISTS v_most_played_tracks;");
            migrationBuilder.Sql("DROP VIEW IF EXISTS v_track_play_counts;");
        }
    }
}
